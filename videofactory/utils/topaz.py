...
def enhance_video_with_ai(input_video: Path, output_path: Path = None, vram: float = 0.75,
                          width: int = 1080, height: int = 1920, fps: int = 60, encoder: str = 'vp9'):
    ...
    if output_path is None:
        ...
        if encoder == 'vp9':  # VP9 Best
            output_filename = basename + '.mp4'
        elif encoder == 'prores':  # ProRes 422 LT
            output_filename = basename + '.mov'
        else:
